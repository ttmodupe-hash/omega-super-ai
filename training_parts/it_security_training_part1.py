...
def _build_courses() -> None:
        ...
        quiz=SecurityQuiz(
            ...
            questions=[
                ...
                QuizQuestion("cq12", "What is the output size of SHA-256?",
                    ["128 bits", "160 bits", "256 bits", "512 bits"], 2,
    ...
    # Store modules
    _modules[mod1.id] = mod1
    _modules[mod2.id] = mod2
    _modules[mod3.id] = mod3

    # ========================================================================
    # COURSES 4-8 will be in part 2
    # ========================================================================

# Auto-init courses on import
_build_courses()
